...
create table issue_type (id integer not null, is_deprecated boolean, name varchar(255), primary key (id));
...
create table users (id integer not null, email varchar(255), password varchar(255), roles smallint array, samaccount_name varchar(255), username varchar(255), primary key (id));
