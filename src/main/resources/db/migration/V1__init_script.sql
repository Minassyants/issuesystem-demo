...
create table good (id varchar(255) not null, description varchar(255), primary key (id));
...
create table vehicle (id varchar(255) not null, description varchar(255), vin varchar(255), primary key (id));
