...
create table chat_members (chat_issue_id integer not null, members_display_name varchar(255) not null);
...
create table issue_department_feedbacks (issue_id integer not null, department_feedbacks_id integer not null);
create table issue_issue_attributes (issue_id integer not null, issue_attributes_id integer not null);
create table issue_issued_employees (issue_id integer not null, issued_employees_display_name varchar(255) not null);
